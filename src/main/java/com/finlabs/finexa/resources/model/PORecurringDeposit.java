...
public class PORecurringDeposit {
	...
	private List<PORecurringDepositLookup> poRecurringLookupList;
	...
	public List<PORecurringDepositLookup> getPoRecurringLookupList() {
		return poRecurringLookupList;
	}

	public void setPoRecurringLookupList(List<PORecurringDepositLookup> poRecurringLookupList) {
		this.poRecurringLookupList = poRecurringLookupList;
	}
