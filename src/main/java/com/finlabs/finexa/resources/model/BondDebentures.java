...
public class BondDebentures {
	...
	private List<BankBondDebenturesLookup> bondDebentureLookupList;
	...
	public List<BankBondDebenturesLookup> getBondDebentureLookupList() {
		return bondDebentureLookupList;
	}

	public void setBondDebentureLookupList(List<BankBondDebenturesLookup> bondDebentureLookupList) {
